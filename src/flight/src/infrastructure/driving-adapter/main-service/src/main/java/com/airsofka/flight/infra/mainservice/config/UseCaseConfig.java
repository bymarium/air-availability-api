...
public class UseCaseConfig {
    ...
    @Bean
    public CreateRouteUseCase createRouteUseCase(MongoAdapter adapter, MySQLAdapterRoute mysqlAdapter) {
        return new CreateRouteUseCase(adapter, mysqlAdapter);
    }

    @Bean
    public DeleteRouteUseCase deleteRouteUseCase(MongoAdapter adapter, MySQLAdapterRoute mysqlAdapter) {
        return new DeleteRouteUseCase(adapter, mysqlAdapter);
    }

    @Bean
    public UpdateRouteUseCase updateRouteUseCase(MongoAdapter adapter, MySQLAdapterRoute mysqlAdapter) {
        return new UpdateRouteUseCase(adapter, mysqlAdapter);
    }

    @Bean
    public DisplayRouteUseCase displayRouteUseCase(MongoAdapter adapter, MySQLAdapterRoute mysqlAdapter) {
        return new DisplayRouteUseCase(mysqlAdapter);
    }

    @Bean
    public ListRoutesUseCase listRoutesUseCase(MySQLAdapterRoute mysqlAdapter) {
        return new ListRoutesUseCase(mysqlAdapter);
    }


    @Bean
    public GetSeatByIDUseCase getSeatByIDUseCase(MySQLAdapter mySQLAdapter) {
        return new GetSeatByIDUseCase(mySQLAdapter);
    }
    @Bean
